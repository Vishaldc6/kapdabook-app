...
const getTranslations = (language: Language) => {
  const translations = {
    en: {
      ...
      gst_type: 'GST Type',
      billNoPlaceholder: 'Enter bill number',
      meterPlaceholder: 'Enter meter value',
      priceRatePlaceholder: 'Enter price rate',
      chalanPlaceholder: 'Enter chalan number',
      takaCountPlaceholder: 'Enter taka count',
      ...
      billNoValidation: 'Bill number must be a valid number',
    ...
    hi: {
      ...
      takaCount: 'टका गिनती',
      gst_type: 'GST प्रकार',
      billNoPlaceholder: 'बिल नंबर दर्ज करें',
      meterPlaceholder: 'मीटर मान दर्ज करें',
      priceRatePlaceholder: 'मूल्य दर दर्ज करें',
      chalanPlaceholder: 'चालान नंबर दर्ज करें',
      takaCountPlaceholder: 'टका गिनती दर्ज करें',
      datePlaceholder: 'YYYY-MM-DD',
      billNoRequired: 'बिल नंबर आवश्यक है',
      ...
      billNoValidation: 'बिल नंबर मान्य संख्या होनी चाहिए',
      ...
      close: 'बंद करें',
      typeOfBill: 'बिल का प्रकार',
      applyFilter: 'फ़िल्टर लागू करें',
      reset: 'रीसेट करें',
      dateFrom: 'तारीख से',
      dateTo: 'तारीख तक',
      allBuyers: 'सभी खरीदार',
      failedToLoadBills: 'बिल लोड करने में विफल',
      bill: 'बिल',
      paid: 'भुगतान किया',
      pending: 'बकाया',
    ...
    gu: {
      ...
      gst_type: 'GST પ્રકાર',
      billNoPlaceholder: 'બિલ નંબર દાખલ કરો',
      meterPlaceholder: 'મીટર કિંમત દાખલ કરો',
      priceRatePlaceholder: 'ભાવ દાખલ કરો',
      chalanPlaceholder: 'ચાલાન નંબર દાખલ કરો',
      takaCountPlaceholder: 'ટકા સંખ્યા દાખલ કરો',
      datePlaceholder: 'YYYY-MM-DD',
      billNoRequired: 'બિલ નંબર જરૂરી છે',
      ...
      billNoValidation: 'બિલ નંબર માન્ય નંબર હોવો જોઈએ',
      ...
      close: 'બંધ કરો',
      typeOfBill: 'બિલનો પ્રકાર',
      applyFilter: 'ફિલ્ટર લાગુ કરો',
      reset: 'રીસેટ કરો',
      dateFrom: 'થી તારીખ',
      dateTo: 'સુધી તારીખ',
      allBuyers: 'બધા ખરીદદાર',
      failedToLoadBills: 'બિલ લોડ થઈ શક્યા નથી',
      bill: 'બિલ',
      paid: 'ચૂકવેલ',
      pending: 'બાકી',
      overdue: 'મિયાદ પાર',
